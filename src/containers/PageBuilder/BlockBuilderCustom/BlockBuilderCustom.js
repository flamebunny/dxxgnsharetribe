...
// Block components
import BlockDefault from './BlockDefaultCustom';
import BlockFooter from './BlockFooterCustom';
import BlockSocialMediaLink from './BlockSocialMediaLinkCustom';
...
const BlockBuilderCustom = props => {
...
const propTypeBlock = shape({
  ...
  // BlockBuilderCustom doesn't really need to care about those
});
...
BlockBuilderCustom.defaultProps = {
  blocks: [],
  options: null,
...
export default BlockBuilderCustom;
