...
import css from './SectionHeroImgCustom.module.css';
...
const SectionHeroImgCustom = props => {
  const {
    sectionId,
    className,
    rootClassName,
  ...
  return (
    <SectionContainer
      id={sectionId}
      className={classNames(className, css.imgwidthunset, css.imgheightunset)}
...
SectionHeroImgCustom.defaultProps = {
  className: null,
  rootClassName: null,
  defaultClasses: null,
  textClassName: null,
...
SectionHeroImgCustom.propTypes = {
